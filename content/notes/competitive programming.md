...
- [cses.fi/problemset](https://cses.fi/problemset/) — do it in order  
- then go to [codeforces.com](https://codeforces.com/) — the real arena  
...
1. loops, arrays, strings  
2. sorting + binary search  
3. prefix sums, two pointers  
4. hashmaps / sets  
5. recursion, backtracking  
6. graphs (DFS, BFS, Union Find, Dijkstra)  
7. DP (the boss level)
...
- join cp Discords/servers (having friends helps)  
